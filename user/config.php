...
define( 'YOURLS_DB_USER', 'seantbur_memebro' );

/** MySQL database password */
define( 'YOURLS_DB_PASS', 'alphaphi342' );

/** The name of the database for YOURLS */
define( 'YOURLS_DB_NAME', 'seantbur_memebro' );

/** MySQL hostname */
define( 'YOURLS_DB_HOST', 'localhost' );

/** MySQL tables prefix */
define( 'YOURLS_DB_PREFIX', 'seantbur_' );
...
define( 'YOURLS_SITE', 'http://memebro.com' );
...
$yourls_user_passwords = array(
	'seantbur_memebro' => 'alphaphi'	// You can have one or more 'login'=>'password' lines
	);
